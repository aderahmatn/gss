...
class Report extends CI_Controller {
	...
	public function exportPeriodik()
	{
		...
		->setTitle("Laporan SPB Periodik $tgl1 s/d $tgl2")
		->setSubject("Laporan SPB Periodik $tgl1 s/d $tgl2")
		->setDescription("Laporan Periodik PT GSS")
		->setKeywords("Laporan SPB Periodik");
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('C3', "GROUP"); // Set kolom C3 dengan tulisan "NAMA"
    $excel->setActiveSheetIndex(0)->setCellValue('D3', "NO SPP"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
    $excel->setActiveSheetIndex(0)->setCellValue('E3', "KODE PART"); // Set kolom E3 dengan tulisan "ALAMAT"
    $excel->setActiveSheetIndex(0)->setCellValue('F3', "NAMA PART"); // Set kolom E3 dengan tulisan "ALAMAT"
    $excel->setActiveSheetIndex(0)->setCellValue('G3', "QTY PLAN"); // Set kolom E3 dengan tulisan "ALAMAT"
    ...
    foreach($report as $data){ // Lakukan looping pada variabel siswa
    	...
    	$excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, strtoupper($data->Lot));
    	$excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, strtoupper($data->NoSpp));
    	$excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, strtoupper($data->KodeBarang));
    	$excel->setActiveSheetIndex(0)->setCellValue('F'.$numrow, strtoupper($data->NamaBarang));
    	$excel->setActiveSheetIndex(0)->setCellValue('G'.$numrow, strtoupper($data->QtyPlan));
    	$excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, strtoupper($data->ActualQty));
    ...
    $excel->getActiveSheet(0)->setTitle("Laporan SPB Periodik");
    $excel->setActiveSheetIndex(0);
    // Proses file excel
    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    header('Content-Disposition: attachment; filename="Laporan_SPB_Periodik_TRSS.xlsx"'); // Set nama file excel nya
