				...
				<div class="card-body">
					<form action="" method="post">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="hidden" name="id" id="id" value="<?=uniqid('MSN')?>" >

								<input type="text" class="form-control form-control-sm <?php echo form_error('nomc')?'is-invalid':''?>" name="nomc" id="nomc" autocomplete="off" aria-describedby="nomchelp" value="<?=set_value('nomc')?>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control form-control-sm <?php echo form_error('merk')?'is-invalid':''?>" name="merk" id="merk" autocomplete="off" aria-describedby="merkhelp" value="<?=set_value('merk')?>" >
								<div class="invalid-feedback">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control form-control-sm <?php echo form_error('tonase')?'is-invalid':''?>" name="tonase" id="tonase" autocomplete="off" aria-describedby="tonasehelp" value="<?=set_value('tonase')?>" >
								<div class="invalid-feedback">
