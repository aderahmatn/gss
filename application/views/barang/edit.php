					...
					<form action="" method="post">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<input type="text" class="form-control form-control-sm <?php echo form_error('kodebrg')?'is-invalid':''?>" name="kodebrg" id="kodebrg" autocomplete="off" aria-describedby="kodebrghelp" value="<?=$this->input->post('kodebrg')?$this->input->post('kodebrg'):$barang->KodeBarang ?>">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control form-control-sm <?php echo form_error('namabrg')?'is-invalid':''?>" name="namabrg" id="namabrg" autocomplete="off" aria-describedby="namabrghelp" value="<?=$this->input->post('namabrg')?$this->input->post('namabrg'):$barang->NamaBarang ?>" >
								<div class="invalid-feedback">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control form-control-sm <?php echo form_error('box')?'is-invalid':''?>" name="box" id="box" autocomplete="off" aria-describedby="boxhelp" value="<?=$this->input->post('box')?$this->input->post('box'):$barang->Box ?>" >
								<div class="invalid-feedback">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control form-control-sm <?php echo form_error('label')?'is-invalid':''?>" name="label" id="label" autocomplete="off" aria-describedby="labelhelp" value="<?=$this->input->post('label')?$this->input->post('label'):$barang->Label ?>" >
								<div class="invalid-feedback">
						...
						<div class="card-footer text-right">
							<button type="submit" class="btn btn-primary btn-sm shadow-sm"><i class="fas fa-save fa-sm"></i> Update</button>
						</div>
					</form>
				</div>
			</div>
